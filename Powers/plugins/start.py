...
async def start(c: Gojo, m: Message):
    ...
    if m.chat.type == ChatType.PRIVATE:
        ...
        try:
            cpt = f"""
Hey [{m.from_user.first_name}](http://t.me/{m.from_user.username})! I am NoxiousXspam✨.
I'm here to help you manage your group(s)!
Hit /help to find out more about how to use me in my full potential!

Join my [News Channel](https://t.me/lundlelobsdkmera) to get information on all the latest updates."""
...
async def start_back(_, q: CallbackQuery):
    try:
        cpt = f"""
Hey [{q.from_user.first_name}](http://t.me/{q.from_user.username})! I am NoxiousXspam ✨.
I'm here to help you manage your group(s)!
Hit /help to find out more about how to use me in my full potential!
